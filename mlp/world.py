...
class world_bird_chirp:
    ...
    """
    reads the "bird_chirp.pnm" spectrum and returns a
    frequency amplitude vector for each time step
    """
    ...
    def __init__(self):
        ...
        print("values' shape=", numpy.shape(self.values))
        KT.exporttiles(self.values, self.height, self.width,
                       "/tmp/coco/obs_I_0.pgm")  # display
    ...
    def sensor(self):
        # return one column of bird_chirp: a 129 long frequency amplitude
        # vector
...
class world_digits:
    ...
    """
    reads the 8x8 image files in digits_alph that display
